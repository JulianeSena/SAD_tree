...
begin
    ...
    -- 16 subtratores em paralelo usando RCA8.
    gen_sub_rca8: for i in 0 to 15 generate
    begin
        u_sub: RCA8
            port map (
                Cin  => '1',
    ...
    gen_acc1_rca8: for i in 0 to 7 generate
    begin
        u_acc1: RCA8
            port map (
                Cin  => '0',
    ...
    gen_acc2_rca9: for i in 0 to 3 generate
    begin
        u_acc2: RCA9
            port map (
                Cin  => '0',
    ...
    gen_acc3_rca10: for i in 0 to 1 generate
    begin
        u_acc3: RCA10
            port map (
                Cin  => '0',
