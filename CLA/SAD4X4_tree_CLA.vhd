...
-- ================================================================
-- SAD4x4_tree com Carry Look Ahead Adder (CLA)
--
-- Objetivo:
--   Calcular o SAD (Sum of Absolute Differences) entre dois blocos
--   4x4 em paralelo, utilizando Carry Look Ahead Adders para melhor
...
begin
    ...
    -- 16 subtratores em paralelo usando CLA8.
    gen_sub_cla8: for i in 0 to 15 generate
    begin
        u_sub: CLA8
            port map (
                Cin  => '1',
    ...
    gen_acc1_cla8: for i in 0 to 7 generate
    begin
        u_acc1: CLA8
            port map (
                Cin  => '0',
    ...
    gen_acc2_cla9: for i in 0 to 3 generate
    begin
        u_acc2: CLA9
            port map (
                Cin  => '0',
    ...
    gen_acc3_cla10: for i in 0 to 1 generate
    begin
        u_acc3: CLA10
            port map (
                Cin  => '0',
