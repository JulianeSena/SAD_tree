...
-- ================================================================
-- CLA11 (Carry Lookahead Adder de 11 bits)
--
-- Objetivo:
...
architecture Behavioral of CLA11 is
     signal G, P: STD_LOGIC_VECTOR(10 downto 0);
     signal C: STD_LOGIC_VECTOR(10 downto 1);
	 
begin
    gen_GP: for i in 0 to 10 generate
          G(i) <= A(i) and B(i);
          P(i) <= A(i) xor B(i);
    end generate;
    ...
    C(10) <= G(9) or (P(9) and G(8)) or (P(9) and P(8) and G(7)) or (P(9) and P(8) and P(7) and G(6)) or (P(9) and P(8) and P(7) and P(6) and G(5)) or (P(9) and P(8) and P(7) and P(6) and P(5) and G(4)) or (P(9) and P(8) and P(7) and P(6) and P(5) and P(4) and G(3)) or (P(9) and P(8) and P(7) and P(6) and P(5) and P(4) and P(3) and G(2)) or (P(9) and P(8) and P(7) and P(6) and P(5) and P(4) and P(3) and P(2) and G(1)) or (P(9) and P(8) and P(7) and P(6) and P(5) and P(4) and P(3) and P(2) and P(1) and G(0)) or (P(9) and P(8) and P(7) and P(6) and P(5) and P(4) and P(3) and P(2) and P(1) and P(0) and Cin);
         
    Cout <= G(10) or (P(10) and G(9)) or (P(10) and P(9) and G(8)) or (P(10) and P(9) and P(8) and G(7)) or (P(10) and P(9) and P(8) and P(7) and G(6)) or (P(10) and P(9) and P(8) and P(7) and P(6) and G(5)) or (P(10) and P(9) and P(8) and P(7) and P(6) and P(5) and G(4)) or (P(10) and P(9) and P(8) and P(7) and P(6) and P(5) and P(4) and G(3)) or (P(10) and P(9) and P(8) and P(7) and P(6) and P(5) and P(4) and P(3) and G(2)) or (P(10) and P(9) and P(8) and P(7) and P(6) and P(5) and P(4) and P(3) and P(2) and G(1)) or (P(10) and P(9) and P(8) and P(7) and P(6) and P(5) and P(4) and P(3) and P(2) and P(1) and G(0)) or (P(10) and P(9) and P(8) and P(7) and P(6) and P(5) and P(4) and P(3) and P(2) and P(1) and P(0) and Cin);
         
    S(0) <= P(0) xor Cin;
    gen_sum: for i in 1 to 10 generate
        S(i) <= P(i) xor C(i);
    end generate;
