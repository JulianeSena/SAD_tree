...
-- ================================================================
-- CSLA10 (Carry Select Adder de 10 bits)
--
-- Objetivo:
...
entity CSLA10 is
    Port (
        ...
        A     : in  STD_LOGIC_VECTOR(9 downto 0);  -- Operando de 10 bits
        B     : in  STD_LOGIC_VECTOR(9 downto 0);  -- Operando de 10 bits
        S     : out STD_LOGIC_VECTOR(9 downto 0);  -- Resultado da soma
        Cout  : out STD_LOGIC                      -- Carry final (vai-um do bit mais significativo)
    );
end CSLA10;

architecture Behavioral of CSLA10 is
    ...
    --   C(0) é carry de saída do bit 0, ..., C(9) do bit 9.
    ...
    signal C0, C1: STD_LOGIC_VECTOR(9 downto 0);
    
begin
    -- Define o carry inicial da cadeia.
    C(-1) <= Cin;

    -- Gera 10 estágios idênticos (um para cada bit, de 0 a 9).
    gen_csa: for i in 0 to 9 generate
    ...
    -- Carry final do somador de 10 bits.
    Cout <= C(9);
end Behavioral;
